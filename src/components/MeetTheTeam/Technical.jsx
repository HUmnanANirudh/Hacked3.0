...
const Technical = () =>{
    return(
        <div className="flex flex-col md:flex-row md:gap-20 justify-center md:justify-evenly items-center">
            ...
            <TeamCards name={"Sejal Gupta"} img={"/assets/Sejal.webp"} about={"If it’s assigned to me, it’s as good as done—dedication on autopilot."}  github={"https://github.com/Sejal207"} linkedin={"https://www.linkedin.com/in/sejal-gupta-943832291/"}/>
        </div>
    )
}
