...
const Core = () =>{
    return(
        <div className="flex flex-col md:flex-row md:flex-wrap justify-center md:justify-around items-center md:space-y-0">
            ...
            <TeamCards img={"/assets/Priyal.png"} name={"Shrey Jaiswal"} about={"Powered by caffeine and pure passion— my calm exterior hides a workaholic on a mission to make everything better."} github={"https://github.com/priyalkhullar"} linkedin={"https://www.linkedin.com/in/priyal-khullar"}/>
