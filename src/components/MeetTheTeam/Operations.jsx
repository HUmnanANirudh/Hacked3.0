...
const Operations = () => {
    return(
        <div className="flex flex-col md:flex-row md:gap-20 justify-center md:justify-evenly items-center">
            <TeamCards name={"Tanmay"} img={"/assets/Tanmay.png"} about={"After 10, I’m all in: coordinating chaos, perfecting operations, and delivering roasts sharper than my timelines."} github={"https://github.com/TanmayGpta"} linkedin={"https://www.linkedin.com/in/tanmay-gupta-b337012b5/"}/>
